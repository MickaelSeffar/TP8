...
/* idea/list.html.twig */
class __TwigTemplate_da3a18ebd3b0b15ac1bc251aed5f8d8dd1982ce2fae5543adb5d685aee962285 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("base.html.twig", "idea/list.html.twig", 1);
    ...
    <ul style=\"list-style-type: none;\">
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["ideas"]) || array_key_exists("ideas", $context) ? $context["ideas"] : (function () { throw new RuntimeError('Variable "ideas" does not exist.', 10, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["idea"]) {
            // line 11
            echo "            <li><a href=\"";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getUrl("idea_detail", ["id" => twig_get_attribute($this->env, $this->source, $context["idea"], "id", [], "any", false, false, false, 11)]), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["idea"], "title", [], "any", false, false, false, 11), "html", null, true);
            echo "</a> (";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["idea"], "category", [], "any", false, false, false, 11), "name", [], "any", false, false, false, 11), "html", null, true);
            echo ")</li>
        ";
        }
...
";
    ...
    {
        return array (  129 => 13,  116 => 11,  112 => 10,  108 => 8,  98 => 7,  79 => 5,  60 => 3,  37 => 1,);
    }
...
{% block name %}Page des idées{% endblock %}

{% block container %}

    <ul style=\"list-style-type: none;\">
        {% for idea in ideas %}
            <li><a href=\"{{ url('idea_detail', { \"id\": idea.id }) }}\">{{ idea.title }}</a> ({{ idea.category.name }})</li>
        {% endfor %}
    </ul>


{% endblock %}
", "idea/list.html.twig", "C:\\Users\\mseffar2020\\Desktop\\Projects\\TP8\\templates\\idea\\list.html.twig");
    }
}
